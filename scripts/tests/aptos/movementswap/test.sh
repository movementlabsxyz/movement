...
aptos move publish --package-dir $PATH_TO_REPO/u256/ --assume-yes
aptos move publish --package-dir $PATH_TO_REPO/TestCoin/ --assume-yes
aptos move publish --package-dir $PATH_TO_REPO/Faucet/ --assume-yes
aptos move publish --package-dir $PATH_TO_REPO/LPResourceAccount/ --assume-yes
...
hex:a11ceb0b0500000005010002020208070a1c0826200a460500000001000200010001084c50436f696e5631064c50436f696e0b64756d6d795f6669656c64${ResourceAccountDeployer#0x}000201020100 --assume-yes
aptos move publish --package-dir $PATH_TO_REPO/Swap/ --assume-yes
