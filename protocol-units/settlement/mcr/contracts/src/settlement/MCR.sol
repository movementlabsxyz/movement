...
contract MCR is Initializable, BaseSettlement, MCRStorage, IMCR {
    ...
    function getAllStakeAtEpoch(
        ...
        return
            stakingContract.getAllStakeAtEpoch(
                address(this),
                epoch,
                custodian,
                attester
    ...
    // todo: memoize this
    // todo: this is could already be taken care of in the staking contract I belive.
    function computeAllStakeAtEpoch(
        ...
        for (uint256 i = 0; i < custodians.length; i++) {
            ...
            totalStake += getAllStakeAtEpoch(epoch, custodians[i], attester);
        }
        return totalStake;
    }
    ...
    function getCurrentEpochStake(
        ...
        return getAllStakeAtEpoch(getCurrentEpoch(), custodian, attester);
    }
