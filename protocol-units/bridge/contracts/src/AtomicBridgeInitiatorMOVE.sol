...
contract AtomicBridgeInitiatorMOVE is IAtomicBridgeInitiatorMOVE, OwnableUpgradeable {
        ...
        returns (bytes32 bridgeTransferId)
    {
        ...
        console.log("ICI initiateBridgeTransfer kk");
