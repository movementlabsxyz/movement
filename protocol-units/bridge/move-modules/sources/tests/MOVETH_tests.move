module MOVETH::moveth_tests{
    ...
    #[test(creator = @0xcafe, minter = @0xface, master_minter = @0xbab, denylister = @0x1)]
    ...
    #[expected_failure(abort_code = 2, location = stablecoin::moveth)]
    ...
    #[test(creator = @0xcafe, denylister = @0x1, receiver = @0xdead)]
