module atomic_bridge::atomic_bridge_counterparty {
    ...
    entry fun initialize(deployer: &signer, moveth_minter: address) {
    ...
    public fun complete_bridge_transfer(
        ...
        let config = borrow_global<BridgeConfig>(signer::address_of(caller));
    ...
    fun test_complete_transfer_assets(
        ...
        // the master minter sets creator to be a minter
        moveth::add_minter(master_minter, signer::address_of(creator));

        //creator now mints themselves 100 moveth
