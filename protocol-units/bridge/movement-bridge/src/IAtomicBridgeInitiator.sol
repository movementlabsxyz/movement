...
interface IAtomicBridgeInitiator {
     ...
     * @param _originator The address allowed to withdraw (claim) the funds once the correct secret 
     is provided on timeout. Used to transfer the funds.
     * @parap _receipient The address on the other chain to which to transer the funds_
     ...
     * @return BridgeTransferId A unique id representing this BridgeTransfer function
     */
